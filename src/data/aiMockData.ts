...
export const SCENARIOS: Record<string, AIScenario> = {
  tactical_dallas: {
    name: "Tactical Pro Forma — Dallas Suppressed",
    sub: "US · Core · Prepaid · Fixed Footprint · 80% Util Cap · 5 of 6 DCs active",
    kpis: { cost: "$41.2M", cpu: "$8.00", days: "4.2d", sla: "46.0%", util: "78.4%" },
    slaColor: "red", utilColor: "green", daysColor: "amber",
    totalCost: 41200000,
    baselineCost: 97500000,
    suppressedDC: "Dallas",
    activeDCs: ["Elwood", "Los Angeles", "R Virginia", "Pharr TX", "Stratford CT"],
    lanesDisplaced: 1492,
    costPenalty: 5100000,
    rvaUtil: 92.4,
    elwoodUtil: 88.2,
